...
public class HypeManager : MonoBehaviour
{
    ...
    public float maxHypePerRace = 200f;
    public float timeBufferRace1 = 95f;
    public float maxTimeRace1 = 240f;
    public float timeBufferRace2 = 70f;
    public float maxTimeRace2 = 210f;
